...
function Data(){
    ...
    <div className="content">
        ...
        <label>Name</label>
        <input type="text" id="name" placeholder="As Entered in SSLC Marksheet" required/><br/>
        <label>Father's Name</label>
        <input type="text" id="fname" placeholder="Your Father's Name" required/><br/>
        ...
        <textarea rows="4" cols="22" id="address" placeholder="Enter Your Address" required></textarea><br/>
        <label>Phone No</label>
        <input type="text" id="phone" placeholder="Enter Your Phone No" required/><br/>
        <label>Qualification</label>
        <input type="text" id="qualification" placeholder="Enter Your Qualification" required/><br/>
        <label>Technical Qualification</label>
        <input type="text" id="school" placeholder="Enter Your Technical Qualification" required/><br/>
        ...
        <input type="text" id="join" placeholder="Enter Your Joining Date" required/><br/>
        <label>Student Picture</label>
        <input type="file" id="pic" onChange={getFile} required/><br></br>
